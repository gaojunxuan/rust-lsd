...
use crate::{data_structs::{ColoredGraph}, constants::{WHITE, GREEN, YELLOW}, hashed_list::HashedList};
...
impl CycleGenerator {
    ...
    pub fn find_next_cycle(&mut self, g: &mut ColoredGraph) -> Option<HashedList<u32>> {
